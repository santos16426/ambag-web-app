  ...
  return (
    <div className="min-h-screen bg-white p-8">
      <div className="max-w-2xl mx-auto">
        ...
        {/* Database Profile */}
        <div className="border border-gray-200 rounded-lg p-6 mb-4">
          <h2 className="text-sm font-medium mb-4">Database Profile (users table)</h2>
          {profile ? (
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-gray-500">Status:</span>
              ...
              <div className="flex justify-between">
                ...
                <span className="truncate max-w-xs">{profile.avatar_url || 'Not set'}</span>
              </div>
              <div className="flex justify-between">
            ...
            <p className="text-sm text-red-600">✗ Profile not found in database</p>
          )}
        </div>
