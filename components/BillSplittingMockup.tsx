    ...
    return (
      <div className="w-full max-w-sm bg-white p-6">
        ...
        <div className="space-y-3">
          {[
            { item: "Classic Cheeseburger", price: "₱675", person: "Alex" },
            {
              item: "Grilled Chicken Sandwich",
              price: "₱612",
              person: "Sarah",
            },
            { item: "Caesar Salad", price: "₱500", person: "Mike" },
            { item: "French Fries", price: "₱275", person: "Alex" },
            { item: "Soft Drink x2", price: "₱300", person: "Shared" },
          ].map((line, idx) => (
            <div
              key={idx}
        ...
        <div className="mt-4 border-t-2 border-slate-300 pt-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-lg font-bold text-purple-600">₱2,362</span>
          </div>
  ...
  if (variant === "expense-tracker") {
    return (
      <div className="w-full max-w-sm  bg-white p-6 ">
        ...
        <div className="mb-4 rounded-lg bg-gradient-to-r from-purple-500 to-purple-600 p-4 text-white">
