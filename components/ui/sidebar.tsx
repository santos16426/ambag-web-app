...
const SIDEBAR_ACTIVE_MENU_COOKIE_NAME = "sidebar_active_menu"
const SIDEBAR_COOKIE_MAX_AGE = 60 * 60 * 24 * 7
const SIDEBAR_WIDTH = "17.5rem" // 280px per design system
...
function SidebarProvider({
  ...
  const setActiveMenu = React.useCallback(
    (value: string | null) => {
      ...
      // Save to cookie
      if (value) {
        document.cookie = `${SIDEBAR_ACTIVE_MENU_COOKIE_NAME}=${value}; path=/; max-age=${SIDEBAR_COOKIE_MAX_AGE}`
      } else {
        // Clear cookie
        document.cookie = `${SIDEBAR_ACTIVE_MENU_COOKIE_NAME}=; path=/; max-age=0`
      }
    },
    []
  )
  ...
  const contextValue = React.useMemo<SidebarContextProps>(
    ...
    [state, open, setOpen, isMobile, openMobile, setOpenMobile, toggleSidebar, _activeMenu, setActiveMenu]
  )
